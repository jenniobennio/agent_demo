            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "contents": {
                            "type": "string",
                            "description": "The details of the single milestone to implement",
                        },
                    },
                    "required": ["agentname", "contents"],
                    "additionalProperties": False,
                },
            }
        }
    ...
    async def execute(self, message_history):
        ...
        if function_name:
            ...
            if function_name == "callAgent":
                ...
                arguments_dict = json.loads(arguments)
                agentname = arguments_dict.get("agentname")
                contents = arguments_dict.get("contents")

                # Check if self is the agent being called
                if agentname == self.name:
                    print("Found myself! " + agentname)
                else:
                    print("Did not find myself! " + agentname)
